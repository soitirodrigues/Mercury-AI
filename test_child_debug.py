...
# Generate child script manually (not using f-string)
child_script_content = '''import sys
import os
import json
sys.path.insert(0, r"C:\\Projetos\\Mercury-AI")
...
atomic_json_write(r"C:\Projetos\Mercury-AI\pid_test_target.json", {repr(test_data)}, indent=2, 
