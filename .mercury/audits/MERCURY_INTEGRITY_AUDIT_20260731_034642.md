...
**Data:** 2026-07-31T03:46:42.733620
...
**Descrição:** main.py crashou em 3 de 3 execuções:
  Run 1: exit=-1, stderr=TIMEOUT após 300s (scanner lento — esperado)
  Run 2: exit=-1, stderr=TIMEOUT após 300s (scanner lento — esperado)
  Run 3: exit=-1, stderr=TIMEOUT após 300s (scanner lento — esperado)
...
| ID | Severidade | Status | Título |
|----|-----------|--------|--------|
| TEST-001 | CRITICAL | ❌ FAIL | Testes com falhas: 79 passed, 21 failed, 0 errors |
| TEST-002 | HIGH | ❌ FAIL | Detalhes das 55 falhas/erros |
| TEST-003 | LOW | ℹ️ INFO | Tempo total de execução: 1272.3s |

#### TEST-001: Testes com falhas: 79 passed, 21 failed, 0 errors

- **Severidade:** CRITICAL
- **Status:** FAIL
- **Localização:** 

**Descrição:** 100 testes total, 1272.3s de execução.

**Recomendação:** Corrigir testes quebrados antes do release.

#### TEST-002: Detalhes das 55 falhas/erros
...
tests/test_auto_health.py::test_auto_health_checks FAILED                [  4%]
...
tests/test_data_provider_manager.py::test_data_provider_manager FAILED   [ 16%]
tests/test_determinism.py::test_determinism FAILED                       [ 21%]
tests/test_engine_performance_auditor.py::test_engine_performance_auditor FAILED [ 22%]
tests/test_health_center.py::test_health_center_data FAILED              [ 32%]
tests/test_health_center.py::test_health_center_panel_load FAILED        [ 33%]
tests/test_institutional_backtest.py::TestIntegrationEndToEnd::test_full_pipeline_multi_symbol FAILED [ 50%]
...
tests/test_pipeline_persistence.py::test_pipeline_snapshot_persistence FAILED [ 74%]
tests/test_probability_engine.py::test_probability_calculation FAILED    [ 75%]
tests/test_provider_priority_engine.py::test_provider_priority_engine_ranking FAILED [ 76%]
tests/test_robustness.py::test_pipeline_robustness FAILED                [ 89%]
tests/test_scanner_recovery.py::test_scanner_auto_recovery_triggers_failover FAILED [ 91%]
tests/test_session_id.py::test_session_id_consistency FAILED             [ 93%]
