...
**Data:** 2026-08-01T11:50:59.613189
...
| RUNTIME-003 | LOW | ℹ️ INFO | Tempo médio de execução: 1.86s (max: 2.61s) |
...
**Descrição:** Chaves esperadas: {'price', 'symbol', 'metadata', 'indicators', 'timestamp', 'decision'}. Alguns relatórios faltam campos obrigatórios.
