...
**Data:** 2026-08-01T14:35:58.890797
...
| RUNTIME-003 | LOW | ℹ️ INFO | Tempo médio de execução: 3.79s (max: 6.63s) |
...
| TEST-003 | LOW | ℹ️ INFO | Tempo total de execução: 1856.8s |
...
**Descrição:** Chaves esperadas: {'metadata', 'timestamp', 'indicators', 'decision', 'price', 'symbol'}. Alguns relatórios faltam campos obrigatórios.
...
**Descrição:** Campos esperados: {'params', 'type', 'version'}
...
**Descrição:** Dependências externas (API, DB, FS, network) em: mercury_ai\analysis\institutional_analytics_engine.py, mercury_ai\analysis\calibration_analyzer.py, mercury_ai\analysis\health_auditor.py, mercury_ai\analysis\data_exporter.py, mercury_ai\analysis\health_checker.py
