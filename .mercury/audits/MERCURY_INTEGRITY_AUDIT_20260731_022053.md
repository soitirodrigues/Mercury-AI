...
**Data:** 2026-07-31T02:20:53.761678
...
| DEP-002 | HIGH | ❌ FAIL | 1 dependência(s) declarada(s) não instalada(s) |
...
#### DEP-002: 1 dependência(s) declarada(s) não instalada(s)

- **Severidade:** HIGH
- **Status:** FAIL
- **Localização:** 

**Descrição:** Pacotes em requirements.txt mas não instalados: scipy
