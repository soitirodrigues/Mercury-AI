...
def test_explainability_engine_analysis():
    ...
    prob = ProbabilityResult(
        buy_probability=72.0,
        sell_probability=5.0,
        neutral_probability=23.0,
        expected_risk=0.1,
        opportunity_grade="EXECUTE",
        institutional_confidence=90.0,
    ...
    assert "Risk factor: 0.10. Class: EXECUTE." in explanation.risk_analysis
